...
<table class="" id="tabr">
    ...
    <?php
    //die;
    $rsp = $main->adminDB[$_SESSION["db_1"]]->query($main->select("winnumber", $_SESSION["db_1"]) . $main->whereSingle(array("gdate" => date("Y-m-d"))) . $main->orderBy("DESC", "gameid").$main->limitWithOutOffset(10));
