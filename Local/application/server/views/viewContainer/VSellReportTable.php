...
$ntotal = 0;
$ftotal = 0;
$sl = $main->select("usertranscation", $_SESSION["db_1"]) . $main->whereBetweenDatesID('on_create', $main->filterPost("cdate"), $main->filterPost("tdate"), "userid", $_POST["userid"]);
...
while ($row = $result->fetch_assoc()) {
    ...
    $tc = $main->getData($main->select("entry", $_SESSION["db_1"]) . $main->where(array("enterydate" => $main->filterPost("cdate"), "id" => $row["invoiceno"]), "AND"), "winamt");
