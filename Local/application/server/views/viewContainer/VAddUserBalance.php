                ...
                <div class="panel-body">
                    ...
                    if (isset($_REQUEST["uid"])) {
                        ...
                        if ($row = $result->fetch_assoc()) {
                            extract($row);
                            ?>
                            <form action="#" method="post" id="sendBal" onsubmit="return formPost3('#sendBal','<?php echo $obj->encdata("C_SendBalance");?>','#dismsg')">
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Send Balance" class="btn btn-success btn-sm">
                                </div>
                            </form>
                            <?php
                        } else {
