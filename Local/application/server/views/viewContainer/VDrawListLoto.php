...
<section class="content">
    <div class="form-group">
        <form action="#" method="post" id="myreport" onsubmit="return formPost3('#myreport', '<?php echo $obj->encdata("C_OpenLinkFalse") . "&v=" . $obj->encdata("VLotoDrawData") . "&tk=0"; ?>', '#displayR')">
            <div class="col-lg-12">
                <div class="form-group">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <input type="date" name="gdate" id="gdate" class="form-control" autocomplete="off" required="">
                    </div>
                    <div class="col-lg-4">
