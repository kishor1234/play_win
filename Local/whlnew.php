...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 730 730">
  ...
  <g class="wheel">
    ...
    <g class="sectors">
      <path id="_1" d="M365,365V35.9A328.1,328.1,0,0,0,200.5,80Z" transform="translate(0)" ></path>
...
<script >// luckywheel animation with Greensock  ---------------------------------
