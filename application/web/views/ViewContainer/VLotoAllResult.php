...
<div class="form-group">
    <div class="col-lg-12">
        <table class="table table-bordered table-striped" id="tabr">
            ...
            <?php
            $rsp = $main->adminDB[$_SESSION["db_1"]]->query($main->select("winnumber", $_SESSION["db_1"]) . $main->whereSingle(array("gdate" => $tdate)) . $main->orderBy("DESC", "gameid").$main->limitWithOutOffset(44));
