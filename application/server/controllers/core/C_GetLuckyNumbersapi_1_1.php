...
class C_GetLuckyNumbersapi_1_1 extends CAaskController {
    ...
    public function create() {
        ...
        if ($t === 0) {
            $_POST["gameid"] = "46";
            $_POST["stime"] = "13:45:00";
            $_POST["etime"] = "13:005:00";
        }
        if (isset($_REQUEST["t"])) {
            $t = (int) $_REQUEST["t"];
    ...
    public function execute() {
        ...
        try {
            ...
            //echo $this->selectSum("lottoweight", "`" . $_POST["gameid"] . "`");
